...
public class TagID3v1 extends Tag {
	...
	public TagID3v1 read(File file) throws FileNotFoundException,IOException {
		...
		if (!str.startsWith("TAG")) return null;
	...
	protected String deleteNull(String str) {
		for (int i = 0; i < str.length(); i++) if (str.charAt(i) == 0) str = new StringBuilder(str).deleteCharAt(i--).toString();
		return str;
	}
