...
public class SampleMulti extends AudioWave implements LineListener {
	...
	public SampleMulti(File file) throws UnsupportedAudioFileException,IOException {
		ais = AudioSystem.getAudioInputStream(file);
	}
	public SampleMulti(URL url) throws UnsupportedAudioFileException,IOException {
